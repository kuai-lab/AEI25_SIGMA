...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self._model_path = "outputs/debug/fridge"
        self.scene_name = 'real_fridge'
        self.dataset = 'paris'
        self.subset = 'realscan'
        self._images = "images"
        self._resolution = -1
        ...
        self.num_slots = 2
        self.center_init = 'cgs' # 'cgs' (coarse gaussians) or 'pcd' (point cloud)
        self.canonical_init = 'cgs'
        self.tau_decay_steps = 10_000
        self.init_from_pcd = False
